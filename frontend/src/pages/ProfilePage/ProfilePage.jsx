    ...
    posts: [
      {
        ...
        excerpt: "A comprehensive guide to understanding and using React Hooks in modern applications...",
        date: "Mar 15, 2024",
        readTime: "8 min read"
      },
      {
        ...
        excerpt: "Learn how to build beautiful interfaces without ever leaving your HTML...",
        date: "Mar 12, 2024",
            ...
            <div>
              ...
              <div className="flex gap-6">
                <div className="text-center">
                  <div style={{ color: darkTheme.colors.primary }} className="font-bold text-xl">
                    {user.followers}
                  </div>
                  <div style={{ color: darkTheme.colors.textSecondary }} className="text-sm">
                    Followers
                  </div>
                </div>
                <div className="text-center">
