  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="md flex justify-center items-center md:border-t-0 md:border-b-0 border-t border-b"
      >
          ...
          <div className="flex justify-between items-center py-4">
            <div>
              <h1
                ...
                className="lg:text-xl md:text-lg text-xl"
              >
                Latest News Updates
              </h1>
              <h1
            ...
            <button className="bg-yellow-400 lg:p-4 md:p-2 p-4 text-lg rounded-full lg:text-2xl md:text-xl">
              <MdArrowOutward />
            </button>
          </div>
          <h1
      ...
      <div
        style={{ borderColor: darkTheme.colors.border }}
        className="md:border-l flex justify-center items-center md:border-t-0 md:border-b-0 border-t border-b"
      >
        <div className="xl:w-[70%] lg:w-[80%] md:w-[90%] w-[90%] py-8 md:py-0">
          <img src={latest2} />
          <div className="flex justify-between items-center py-4">
